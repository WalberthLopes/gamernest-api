...
var userVerify = function (username, email, discord) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, data, error, response;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (data) {
                    ...
                    return [2 /*return*/, response === null || response === void 0 ? void 0 : response[0]];
                }
                else {
                    console.log(error);
